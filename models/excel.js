...
module.exports = function(post){
  ...
  ws.cell(2,2).string('건물명').style(style);
  ws.cell(2,3).string('이름').style(style);
  ws.cell(2,4).string('구').style(style);
  ws.cell(2,5).string('주소').style(style);
  ...
  for(jsnum in postJson){
    ...
    ws.cell(cellnum,2).string(`${postJson[jsnum].wr22}`).style(style);
    ws.cell(cellnum,3).string(`${postJson[jsnum].wr1}`).style(style);
    ws.cell(cellnum,4).string(`${postJson[jsnum].wr19}`).style(style);
    ws.cell(cellnum,5).string(`${postJson[jsnum].wr4}`).style(style);
